...
<?
	...
	echo "<br> <a href = 'index.php'>К списку фильмов</a> | <a href = 'editfilm.php?id=$id_film' >Редактировать информацию о фильме</a> ";
...
<table width='100%'>
<tr>
	<td width='30%' valign = 'top'> <img src='posters/$id_film/$poster'/> 
